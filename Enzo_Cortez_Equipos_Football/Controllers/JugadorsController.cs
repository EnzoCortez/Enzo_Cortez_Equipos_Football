...
namespace Enzo_Cortez_Equipos_Football.Controllers
{
    public class JugadorsController : Controller
    {
        private readonly Enzo_Cortez_Equipos_FootballContext _context;

        public JugadorsController(Enzo_Cortez_Equipos_FootballContext context)
        {
            _context = context;
        }
        ...
        {
            var enzo_Cortez_Equipos_FootballContext = _context.Jugador.Include(j => j.Equipo);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Posicion,Edad,EquipoId")] Jugador jugador)
        {
            ...
            ViewData["EquipoId"] = new SelectList(_context.Equipo, "Id", "Id", jugador.EquipoId);
            return View(jugador);
        }
